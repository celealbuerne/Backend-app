...
const storage = multer.diskStorage({  //las imagenes se guardan en disco, en esa carpeta
...
const fileFilter = (
    ...
    if (tiposPermitidos.includes(file.mimetype)) { //mime type es el tipo de archivo
