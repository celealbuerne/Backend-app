...
publicacionRouter.post("/", uploadImagenPublicacion.single('imagen'), md.sanitizeInput, md.validarCrearPublicacion, publicacionController.saveOne);
...
publicacionRouter.put("/:id", uploadImagenPublicacion.single('imagen'), md.sanitizeInput, md.validarCrearPublicacion, publicacionController.updateOne);
publicacionRouter.patch("/:id", uploadImagenPublicacion.single('imagen'), md.sanitizeInput, md.validarActualizarDatos, publicacionController.updateOne);
